        ...
        <body id="page-top">
            ...
            <div id="wrapper">
                ...
                <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <!-- Nav Item - Dashboard -->
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('supplier.homePage') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link collapsed" href="" data-toggle="collapse"
                            ...
                            <i class="fas fa-shopify"></i>
                            <span>Products</span>
                        </a>
                        <div id="collapseProduct" class="collapse" aria-labelledby="headingTwo"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <a class="collapse-item" href="{{ route('supplier.product.index') }}">All Products</a>
                                {{-- <h1>{{ $adminPermission->route_name }}</h1> --}}

                                {{-- @if (has_permission($create_route)) --}}
                                <a class="collapse-item" href="{{ route('supplier.product.create') }}">Add New</a>
                                {{-- @endif --}}
                            </div>
                        </div>
                    </li>
                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                            ...
                            <p class="mt-3">
                                <a href="{{ route('supplier.homePage') }}"
                                    class="text-gray-600 text-decoration-none">Home
                                    Page</a><span>/</span>
                                @yield('breadcrumb')
                            </p>
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown no-arrow">
                                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown"
                                        ...
                                        aria-expanded="false">
                                        <span
                                            class="mr-2 d-none d-lg-inline text-gray-600 small">{{ Auth::guard('supplier')->user()->name }}</span>
                                        <img class="img-profile rounded-circle" style="object-fit: cover"
                                            src="{{ Auth::guard('supplier')->user()->img_path }}">
                                    </a>
            ...
            <script>
                let authID = "{{ Auth::guard('supplier')->user()->id }}"
                let guard = 'admin'
            </script>
