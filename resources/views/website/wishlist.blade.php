        ...
        <div class="wishList m-3 p-4">
            ...
            <div class="d-flex justify-content-start flex-wrap">
                <div class="wishList-item">
                    ...
                    <div class="heart">
                        <span style="color: white">5000K</span>
                        <i class="fas fa-heart" style="color: red"></i>
                    </div>
                </div>
                <div class="wishList-item">
                    <div class="image-wishlist">
                        <img src="{{ asset('website/images/بلوزة نايك.jpg') }}" alt="">
                    </div>
                    <div class="title-wishlist">
                        <h5 class="mb-0">product 1</h5>
                    </div>
                ...
                <div class="wishList-item">
                    <div class="image-wishlist">
                        <img src="{{ asset('website/images/Mixed Socks.jpg') }}" alt="">
                    </div>
                    <div class="title-wishlist">
                        <h5 class="mb-0">product 1</h5>
                    </div>
