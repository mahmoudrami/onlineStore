    ...
    <body>
        ...
        <div class="header">
            <nav class="d-flex justify-content-between align-items-center">
                ...
                <ul class="d-flex justify-content-between flex-row-reverse align-items-center">
                    ...
                    <li class="mx-4"><i class="fas fa-heart"></i></li>
        ...
        <div class="d-flex" style="background-color: #eee">
            <div class="p-5" style="height: 500px">
                ...
                <p class="mt-4" style="font-size: 25px">We're truly glad to have you here. At our store, you'll find
                    everything
        ...
        <div class="p-3 m-4">
            ...
            <div id="priority">
                ...
                <div class="d-flex mx-auto">
                    <div class="me-3">
                        <img src="{{ asset('website/images/24-hours-support.png') }}" width="50px" alt="">
                    </div>
                    <div class="p-2 content-service">
                        <h3>24/7 Customer Support</h3>
                        <p>We’re always here to help you -day or night- via chat or email.
                        </p>
                    </div>
                </div>
                <div class="d-flex mx-auto">
                    <div class="me-3">
                        <img src="{{ asset('website/images/credit-card.png') }}" width="50px" alt="">
                    </div>
                    <div class="p-2 content-service">
                        <h3>Flexible Payments</h3>
                        <p>Pay the way you prefer card, bank, or cash on delivery. Always encrypted and safe.</p>
                    </div>
                </div>
                <div class="d-flex mx-auto">
                    <div class="me-3">
                        <img src="{{ asset('website/images/original.png') }}" width="50px" alt="">
                    </div>
                    <div class="p-2 content-service">
                        <h3>Authentic Products</h3>
                        <p>We only sell high-quality, original items. No fakes, no compromises.</p>
                    </div>
                </div>
            </div>
        </div>
