            ...
            <div class="swiper mySwiper m-1 my-3 p-3" style="background-color: #faedea">
                <div class="mb-1 header-swiper">
                    <img src="{{ asset('website/images/down-arrow.png') }}" width="50px" alt=""
                        style="position: absolute;transform: rotate(320deg)">
                    <h3 class="p-3">love farah</h3>
                </div>
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="card">
                            <div>
                                <img src="{{ asset('images/products/10996592941746192416.jpg') }}"
                                    class="card-img-top" alt="product 1">
                            </div>
                            <div class="card-body">
                                <h3 class="card-title">$<span>2</span>.00</h3>
                                <p class="card-text my-2">$24</p>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
