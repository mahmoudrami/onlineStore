...
@section('content')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group">
            @if (has_permission('admin.order.delete'))
            ...
            @endif
            @if (has_permission('admin.order.edit'))
            ...
            @if (has_permission('admin.order.create'))
        ...
        <tbody>
            @forelse ($orders as $order)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.order.edit', $order->id) }}" class="btn btn-sm btn-primary"><i
