...
<html lang="en">
    ...
    <body id="page-top">
                                ...
                                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle" {{ asset('backend/img/undraw_profile_1.svg') }}
                                                alt="...">
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle" {{ asset('backend/img/undraw_profile_2.svg') }}
                                                alt="...">
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle" {{ asset('backend/img/undraw_profile_3.svg') }}
                                                alt="...">
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle"
                                                {{ asset('backend/https://source.unsplash.com/Mv9hjnEUHR4/60x60') }}
                                                alt="...">
                                            <div class="status-indicator bg-success"></div>
                                        </div>
                                        <div>
        ...
        <script {{ asset('backend/vendor/jquery/jquery.min.js') }}></script>
        <script {{ asset('backend/vendor/bootstrap/js/bootstrap.bundle.min.js') }}></script>

        <!-- Core plugin JavaScript-->
        <script {{ asset('backend/vendor/jquery-easing/jquery.easing.min.js') }}></script>

        <!-- Custom scripts for all pages-->
        <script {{ asset('backend/js/sb-admin-2.min.js') }}></script>
        <script>
